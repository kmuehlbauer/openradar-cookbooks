...
#
# openradar-cookbooks documentation build configuration file
#
...
project = u'openradar-cookbooks'
copyright = u'2017, openradar developers'
...
# git revision in CI built docs
if 'CI' in os.environ and os.environ['CI'] == 'true':
    commit = os.environ['TRAVIS_COMMIT']
    repo_slug = os.environ['TRAVIS_REPO_SLUG']
else:
    commit = git_version()
    repo_slug = 'openradar/openradar-cookbooks'

extlinks = {'commit': ('https://github.com/{0}/commit/{1}%s'.format(repo_slug, commit), '{0}'.format(commit))}
...
html_short_title = "openradar-cookbooks"
...
htmlhelp_basename = 'openradar-cookbooks-doc'
...
latex_documents = [('index', 'openradar-cookbooks.tex', u'openradar-cookbooks Documentation',
                    u'openradar developers', 'manual'), ]
...
man_pages = [
    ('index', 'openradar-cookbooks', u'openradar-cookbooks Documentation',
     [u'openradar developers'], 1)
]
